...
public function totalRegistro($registro){
    $conexao = Connection::conectar();
    $query "SELECT COUNT(id_historico_atendimento_cliente) FROM historico_atendimento_cliente WHERE registro_cliente = '$registro'";
    $resultado = $conexao->query($query);
    return $resultado;
}
