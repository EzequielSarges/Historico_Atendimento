...
while($linha_result = mysqli_fetch_assoc($result)){
    ...
    $query = "SELECT c.PK_ID_CONTROLLER, c.FK_ID_SISTEMA, a.PK_ID_ACTION FROM  tb_controllers c INNER JOIN tb_actions a ON c.PK_ID_CONTROLLER = a.FK_ID_CONTROLLER 
    ...
    while($linha_resultado = mysqli_fetch_assoc($resultado)){
        ...
        if($linha_resultado['PK_ID_ACTION']){
            $linhas = $linha_resultado['PK_ID_ACTION'];
            var_dump ($linhas);
